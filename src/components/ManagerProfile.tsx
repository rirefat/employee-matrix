        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-3xs flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="text-center sm:text-left space-y-2 flex-1">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-1.5 text-xs font-semibold text-slate-500">
              ...
              <span className="group flex items-center gap-1.5 bg-slate-50 px-2.5 py-0.5 rounded-md text-xs border border-slate-100 hover:border-indigo-200 hover:bg-indigo-50/30 transition-all cursor-default">                <div className="relative flex items-center justify-center text-slate-500 group-hover:text-indigo-500 transition-colors">                  <Fingerprint className="w-3.5 h-3.5" />                  <motion.div                     className="absolute left-0 right-0 h-[1px] bg-indigo-500 shadow-[0_0_4px_0_rgba(99,102,241,0.5)] opacity-0 group-hover:opacity-100"                    animate={{ top: ['0%', '100%', '0%'] }}                    transition={{ duration: 1.5, ease: "linear", repeat: Infinity }}                  />                </div>                <span className="font-mono font-bold text-slate-600 group-hover:text-indigo-700 transition-colors">ID: {employeeId}</span>              </span>
            </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <select 
                            ...
                            className="w-full pl-10 pr-10 h-10 bg-slate-50 border border-slate-200 focus:border-indigo-400 focus:bg-white rounded-xl text-xs font-bold text-slate-700 transition-all outline-none appearance-none"
                          >
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        <div className="flex flex-col justify-between p-4 border border-slate-200/80 rounded-2xl bg-slate-50/10">
                          <div className="space-y-3">
                            <div>
                              <label className="block text-[11px] font-bold text-slate-500 mb-1">Google Drive Link to Resume</label>
                              <input 
                                type="url"
                            ...
                            <p className="text-[11px] text-slate-500 leading-relaxed">
                              Share a direct link to a Google Drive document for your resume.
                            </p>
                          </div>
