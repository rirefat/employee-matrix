...
export const dummyManagers: Manager[] = [
  ...
  },
  {
    ...
    department: 'Design',
    joinDate: '2024-05-10',
    reportingTo: 'Operation Manager - FSD',
    emergencyContactName: 'Jane User',
    ...
    education: 'B.S. in Design',
    certifications: 'UI/UX Certified',
    linkedinLink: 'https://linkedin.com/in/general-user',
    githubLink: 'https://github.com/general-user',
    preferredLanguage: 'English (US)',
    timezone: 'America/New_York'
  }
];
